package io.github.liuruinian.im.core.constant;

/**
 * @author liuruinian
 * @version 2022-02-03 23:34:56
 * <p>
 *     腾讯im相关API接口常量类
 * </p>
 */
public class TencentCloudImApiConstant {
    ...
    /**
     * API_HTTPS_URL_PREFIX
     */
    public static final String HTTPS_URL_PREFIX = "https://console.tim.qq.com/";
     ...
     * 全员推送
     */
    public static class WholePushManage {
        /**全员推送*/
     ...
     * 关系链管理
     */
    public static class RelationChainManage {
        /**添加好友*/
     ...
     * 全局禁言管理
     */
    public static class GlobalMuteManage {
        /**设置全局禁言*/
