package io.github.liuruinian.redis.autoconfigure;

import io.github.liuruinian.redis.properties.RedissonProperties;
import io.github.liuruinian.redis.serializer.RedisObjectSerializer;
	...
	public LettuceConnectionFactory lettuceConnectionFactory(GenericObjectPoolConfig genericObjectPoolConfig) {
		...
		if (redisProperties.getSentinel() != null) {
			...
			ClusterTopologyRefreshOptions topologyRefreshOptions = ClusterTopologyRefreshOptions.builder()
					...
					// 开周期刷新 ClusterTopologyRefreshOptions.DEFAULT_REFRESH_PERIOD
