 ...
 */
package io.github.liuruinian.uid.impl;

import io.github.liuruinian.uid.buffer.BufferPaddingExecutor;
import io.github.liuruinian.uid.buffer.RejectedPutBufferHandler;
import io.github.liuruinian.uid.buffer.RejectedTakeBufferHandler;
import io.github.liuruinian.uid.buffer.RingBuffer;
import io.github.liuruinian.uid.exception.UidGenerateException;
...
/**
 * Represents a cached implementation of {@link com.chana.mazda.uid.UidGenerator} extends
 ...
 *                        will be <code>({@link com.chana.mazda.uid.BitsAllocator#getMaxSequence()} + 1) &lt;&lt;
...
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
     ...
     * 
     * @param currentSecond
     * @return UID list, size of {@link com.chana.mazda.uid.BitsAllocator#getMaxSequence()} + 1
     */
